...
description: Compatibility alias for single-receptor LigPrep and Glide SP after QikProp filtering. Use only when an existing task names ddfast-07; route new H2/H5 work to funnel-glide-sp and never use this alias for multi-receptor workflows.
---

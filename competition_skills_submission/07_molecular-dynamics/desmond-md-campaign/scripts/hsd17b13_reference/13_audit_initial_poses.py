...
def main():
    ...
    crystal_path = os.environ.get("EDRUG_REFERENCE_LIGAND")
    if not crystal_path:
        raise RuntimeError("Set EDRUG_REFERENCE_LIGAND before running this audit")
    crystal = read(Path(crystal_path).expanduser())

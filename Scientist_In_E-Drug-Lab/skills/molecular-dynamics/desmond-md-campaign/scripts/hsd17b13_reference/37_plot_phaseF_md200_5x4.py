#!/usr/bin/env python3
"""Render Phase F 200 ns RMSD as five rows by four columns on portrait A4."""
...
DEFAULT_TRACES = ANALYSIS / "final_200ns" / "md200_traces.csv"
DEFAULT_DECISIONS = ANALYSIS / "final_200ns" / "md200_decision_table.csv"
DEFAULT_OUTPUT = ANALYSIS / "final_200ns" / "figures" / "phaseF_md200_rmsd_5high_4wide"

# The four supplemental candidates occupy the empty preview slots until their
# completed trajectories are added to the final combined analysis.
SUPPLEMENTAL_IDS = ["T16866", "T3232", "T5S0045", "T6307"]
...
def ordered_ids(
    ...
    if requested:
        ...
        ids.extend(mid for mid in SUPPLEMENTAL_IDS if mid not in ids)
    if len(ids) > 20:
...
def render(
    ...
    figure.savefig(
        ...
        metadata={"Title": "Phase F 200 ns protein and ligand RMSD"},
    )
